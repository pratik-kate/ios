...
extension NCSelect {
    ...
    @objc func loadDatasource(withLoadFolder: Bool) {
        ...
        richWorkspaceText = NCManageDatabase.shared.getTableDirectory(predicate: NSPredicate(format: "account == %@ AND serverUrl == %@", activeAccount.account, serverUrl))?.richWorkspace
